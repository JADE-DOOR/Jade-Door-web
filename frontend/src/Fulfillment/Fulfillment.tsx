              ...
              <tr key={fulfillment.id}>
                ...
                <td>
                  <span 
                    ...
                    style={{ 
                      color: fulfillment.status === 'unshipped' ? '#a02020' : '#204020',
                      fontWeight: 'bold'
                    }}
                  >
        ...
        <div className="summary-stats">
          <div className="stat-card">
            <span className="stat-number">
              {fulfillmentData.filter(item => item.status === 'shipped').length}
            </span>
            <span className="stat-label">Shipped Orders</span>
          </div>
          <div className="stat-card">
            <span className="stat-number" style={{color: '#a02020'}}>
              {fulfillmentData.filter(item => item.status === 'unshipped').length}
            </span>
